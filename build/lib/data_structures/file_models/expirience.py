...
json_path_exp = parent_directory / "data_bases" / "expirience.json"
json_path_cont = parent_directory / "data_bases" / "contacts.json"
...
class expirience(BaseModel):
    ...
    def set_exp_data(cls, values):
        exp_data = json.load(open(json_path_exp,"r"))
        contacts_data = json.load(open(json_path_cont, "r"))
